...
3. Make sure that `/wp-content/plugins/private_socialmedia/cache/` is writeable
4. Go to the settings page and select the social media platformt that you want to use
